...
public static class Registry
{
    ...
    [
        ...
        new("spaceBefore", PropType.String, "Space before the paragraph in points (6pt) or a length; none removes it.") { Example = "6pt", Formats = Docx },
        new("spaceAfter", PropType.String, "Space after the paragraph in points (8pt) or a length; none removes it.") { Example = "8pt", Formats = Docx },
    ...
    [
        ...
        new("table", "Table.")
        {
            ...
            [
                ...
                new("header", PropType.Bool, "The first row is a header row (the style draws it so).") { Example = "true", Formats = Pptx },
